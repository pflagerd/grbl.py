...
| runHomingCycleSetOriginSendGCodeFile.py                   | Runs a homing cycle, sets the origin to a given x, y, z, moves the cutting head to that same x, y, z and sends a given gcode file to the CNC machine.                                                                     |
