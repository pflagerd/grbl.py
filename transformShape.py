...
def main(args):
    return cutToadstoolStoLowerLeft()
...
def carveToadstoolStoLowerLeft():
    ...
    with open("/home/oy753c/desktops/toadstool/carveco/Toolpaths/Toadstool Logo Scaled to 30 wide - sto.birch plywood.B/carveToadstoolStoLowerLeft.gcode", "w") as gcodeFile:
        gcodeFile.write(gcodeOutputLines)


def cutToadstoolStoLowerLeft():
    lowerLeftStoConventionalInsideGcodeFilename = "/home/oy753c/desktops/toadstool/carveco/Toolpaths/Toadstool Logo Scaled to 30 wide - sto.birch plywood.B/lower left sto conventional inside.gcode"
    with open(lowerLeftStoConventionalInsideGcodeFilename, "r") as gcodeFile:
        lowerLeftStoConventionalInsideGcode = gcodeFile.read()
    ...
    with open("/home/oy753c/desktops/toadstool/carveco/Toolpaths/Toadstool Logo Scaled to 30 wide - sto.birch plywood.B/cutToadstoolStoLowerLeft.gcode", "w") as gcodeFile:
        gcodeFile.write(gcodeOutputLines)
